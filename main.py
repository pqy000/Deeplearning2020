...
from models import LSTNet,MHA_Net,CNN,RNN, LSTRes
import importlib
import numpy as np
...
with open(args.save, 'rb') as f:
    model = torch.load(f)
test_acc, test_rae, test_corr, predict = evaluate(Data, Data.test[0], Data.test[1], model, evaluateL2, evaluateL1,args, True)
